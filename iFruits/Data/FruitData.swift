...
let fruitsData: [Fruit] = [
    Fruit(title: "Blueberry", headline: "Blueberries are sweat, nutritious and wildly popular all over the world", image: "blueberry", gradientColors: [Color("ColorBlueberryLight"), Color("ColorBlueberryDark")], description: "Blueberries are prennial flowering plants with blue or purple berries.", nutrition: ["240kJ", "9.96 g", "0.33 g", "0.75 g", "A, B1", "Calcium, Magnesium"]),
    Fruit(
      title: "Strawberry",
